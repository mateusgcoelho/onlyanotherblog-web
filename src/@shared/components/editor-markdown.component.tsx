  ...
  return (
    <div className="flex-1 w-full flex h-96 gap-x-4">
      <section className="flex flex-col w-[50%] flex-1 h-96">
        ...
        />
        <textarea
          className="border placeholder:text-slate-500 border-slate-500 bg-transparent rounded-md text-sm p-2 focus:border-purple-600 outline-none focus:shadow-2xl focus:shadow-blue-500/20 transition-all w-full flex-1 overflow-y-auto resize-none"
...
export function MyMarkdownPreview({ source }: { source: string }) {
